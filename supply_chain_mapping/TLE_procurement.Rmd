...
#Set up dataset
countries = geojson_read("https://raw.githubusercontent.com/johan/world.geo.json/master/countries.geo.json", method = "local")
...
commodity_select = merge(countries, temp, by.x= "ADMIN", by.y = "country")
...
server <- function(input, output, session) {
  ...
  output$table <- renderTable(country_sub())
